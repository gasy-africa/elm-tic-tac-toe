...
var _user$project$Styles$winner = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'min-height', _1: '60px'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$containerChooseButtons = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'min-height', _1: '60px'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$chooseButtons = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$buttons = _elm_lang$html$Html_Attributes$style(
	{
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'min-height', _1: '40px'},
			_1: {ctor: '[]'}
		}
	});
var _user$project$Styles$box = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$innerContainer = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		_1: {ctor: '[]'}
	});
var _user$project$Styles$container = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'widht', _1: '100%'},
						_1: {
							ctor: '::',
...
var _user$project$Main$hasWinner = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.turn;
	var _p2 = _p1.board;
	var forward = A2(
		...
		A3(
			...
			F3(
				function (idx, curr, acc) {
					return (_elm_lang$core$Native_Utils.eq(idx, 2) || (_elm_lang$core$Native_Utils.eq(idx, 4) || _elm_lang$core$Native_Utils.eq(idx, 6))) ? {ctor: '::', _0: curr, _1: acc} : acc;
				}),
			{ctor: '[]'},
			_p2));
	var backward = A2(
		...
		A3(
			...
			F3(
				function (idx, curr, acc) {
					return (_elm_lang$core$Native_Utils.eq(idx, 0) || (_elm_lang$core$Native_Utils.eq(idx, 4) || _elm_lang$core$Native_Utils.eq(idx, 8))) ? {ctor: '::', _0: curr, _1: acc} : acc;
				}),
			{ctor: '[]'},
			_p2));
	var columns = A2(
		...
		_elm_community$list_extra$List_Extra$transpose(
			A2(_elm_community$list_extra$List_Extra$groupsOf, 3, _p2)));
	var rows = A2(
		_elm_lang$core$List$any,
		_elm_lang$core$List$all(
			F2(
...
var _user$project$Main$handleBoardFull = function (_p4) {
	return !A2(
		_elm_lang$core$List$any,
		function (v) {
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {player1: a, player2: b, turn: c, board: d, isBoardFull: e, hasSetPlayer: f, hasWinner: g, hasStarted: h};
	});
var _user$project$Main$initModel = A8(
			...
			switch (_p6.ctor) {
				case 'Mark':
					...
					var nextTurn = _elm_lang$core$Native_Utils.eq(
						A2(_user$project$Main$getValue, _p7, model),
					...
					var nextBoard = _elm_lang$core$Native_Utils.eq(
						...
						_elm_lang$core$Maybe$withDefault,
						{ctor: '[]'},
						A3(_elm_community$list_extra$List_Extra$setAt, _p7, model.turn, model.board)) : model.board;
					var nextWinner = _user$project$Main$hasWinner(
						_elm_lang$core$Native_Utils.update(
							model,
							{board: nextBoard}));
					...
					return nextWinner ? A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{hasWinner: true, board: nextBoard}),
						{ctor: '[]'}) : A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{board: nextBoard, turn: nextTurn, isBoardFull: isBoardFull, hasStarted: true}),
						{
							ctor: '::',
							_0: nextCmd,
							_1: {ctor: '[]'}
				...
				case 'Rand':
					...
					var hasValue = !_elm_lang$core$Native_Utils.eq(
						A2(_user$project$Main$getValue, _p8, model),
						'');
					if (hasValue) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
						...
						var _v3 = _user$project$Main$Mark(_p8),
							_v4 = model;
						msg = _v3;
						model = _v4;
						continue update;
				...
				default:
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								player1: _p9,
								player2: _user$project$Main$handleChangeTurn(_p9),
								turn: _p9,
								hasSetPlayer: true
							}),
						{ctor: '[]'});
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: (!model.hasSetPlayer) ? A2(
						...
						{
							ctor: '::',
							_0: model.hasStarted ? _elm_lang$html$Html$text('') : _elm_lang$html$Html$text(
								_elm_lang$core$String$toUpper('Choose Player')),
							_1: {
								ctor: '::',
								_0: model.hasStarted ? _elm_lang$html$Html$text('') : A2(
									_elm_lang$html$Html$div,
									{
										ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: (model.isBoardFull || model.hasWinner) ? A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Styles$winner,
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: model.hasWinner ? _elm_lang$html$Html$text(
											A2(_elm_lang$core$Basics_ops['++'], model.turn, ' has won!')) : _elm_lang$html$Html$text(''),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
